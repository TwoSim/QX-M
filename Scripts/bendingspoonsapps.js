...
[Script]
Bendingspoonsapps = type=http-response,pattern=^https:\/\/.+\.oracle\.bendingspoonsapps\.com\/v2\/(purchases\/verify\/apple|purchases\/sign\/apple|users\/setup|users\/legal)$,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/TwoSim/QX-M/refs/heads/main/Scripts/bendingspoonsapps.js,script-update-interval=-1
